...
/* When getting the password from EEPROM, we will save the password in that variable (or)
 * when receiving the password from the HMI ECU, we will save the password in this variable in order to compare and
 * sending it to the EEPROM.
 * */
...
/* Very important variable that will make the decisions of the whole system*/
